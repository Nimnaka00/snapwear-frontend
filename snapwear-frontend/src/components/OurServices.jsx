...
const services = [
  {
    icon: deliveryIcon,
    title: 'Free Delivery',
    description: 'Get your fashion fix shipped fast — for free, no minimum required.'
  },
  {
    icon: customerIcon,
    title: '24/7 Customer Servicer',
    description: 'We’re here for you anytime, anywhere — style help is just a message away.'
  },
  {
    icon: returnIcon,
    title: 'Easy Returns',
